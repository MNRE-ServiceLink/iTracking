...
var serviceTime ="";
if(text3=="สำนักงานปลัดกระทรวงทรัพยากรธรรมชาติและสิ่งแวดล้อม"){serviceTime = "08.00 น. ถึง 17.00 น. ไม่พักกลางวันค่ะ";}
else if(text3=="องค์การสวนสัตว์แห่งประเทศไทย"){serviceTime = "08.30 น. ถึง 16.30 น. ค่ะ";}
else if(text3=="กรมอุทยานแห่งชาติ สัตว์ป่าและพันธุ์พืช"){serviceTime = "08.30 น. ถึง 16.30 น. ค่ะ";}
else if(text3=="กรมควบคุมมลพิษ"){serviceTime = "08.30 น. ถึง 16.30 น. ค่ะ";}
else if(text3=="กรมส่งเสริมคุณภาพสิ่งแวดล้อม"){serviceTime = "08.30 น. ถึง 16.30 น. ค่ะ";}
else if(text3=="สำนักงานโยบายและแผนทรัพยากรธรรมชาติและสิ่งแวดล้อม"){serviceTime = "08.30 น. ถึง 16.30 น. ค่ะ";}
else if(text3=="กรมป่าไม้"){serviceTime = "08.30 น. ถึง 16.30 น. ค่ะ";}
else if(text3=="กรมทรัพยากรทางทะเลและชายฝั่ง"){serviceTime = "08.30 น. ถึง 16.30 น. ค่ะ";}
else if(text3=="กรมทรัพยากรธรณี"){serviceTime = "08.30 น. ถึง 16.30 น. ค่ะ";}
else if(text3=="กรมทรัพยากรน้ำ"){serviceTime = "08.30 น. ถึง 16.30 น. ค่ะ";}
else if(text3=="กรมทรัพยากรน้ำบาดาล"){serviceTime = "08.30 น. ถึง 16.30 น. ค่ะ";}
else if(text3=="องค์การอุตสาหกรรมป่าไม้"){serviceTime = "08.30 น. ถึง 16.30 น. ค่ะ";}
else if(text3=="องค์การบริหารจัดการก๊าซเรือนกระจก"){serviceTime = "08.30 น. ถึง 16.30 น. ค่ะ";}
else if(text3=="สำนักงานพัฒนาเศรษฐกิจจากฐานชีวภาพ"){serviceTime = "08.30 น. ถึง 16.30 น. ค่ะ";}
else{serviceTime = "";}
	...
	if(text=="AA123456"){window.alert("รหัสคำขอนี้ เป็นเพียงตัวอย่าง ไม่มีข้อมูลความคืบหน้าค่ะ");}
		...
		window.alert(document.getElementById("iRequest").innerHTML = 
       		...
       		document.getElementById("orgEmail").innerHTML = 
            		"สอบถามเพิ่มเติม: <br>" + text3 + " <br>อีเมล "+ eMail + "<br>โทร. " + orgTel + "<br>ทุกวันทำการ ตั้งแต่เวลา " + serviceTime;
