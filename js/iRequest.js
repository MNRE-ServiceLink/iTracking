...
if(text3=="สำนักงานปลัดกระทรวงทรัพยากรธรรมชาติและสิ่งแวดล้อม"){eMail = "servicelinkcenter@mnre.go.th";}
  ...
  window.alert(document.getElementById("iRequest").innerHTML = 
            "เรียน ท่านผู้ใช้บริการ สป.ทส. ศูนย์บริการร่วม ทส. ขอเรียนว่า เรื่องตามรหัสคำขอ " + text + " อยู่ระหว่างการพิจารณาของคณะกรรมการข้อมูลข่าวสาร สป.ทส. ค่ะ");
       document.getElementById("orgEmail").innerHTML = 
            "ผู้ขอสามารถสอบถามเพิ่มเติม โดยส่งคำถามไปยัง" + text3 + " ทางอีเมล "+ eMail + " หรือ โทร. 0 2265 6223-5 ทุกวันทำการ ตั้งแต่เวลา 08.00 น. - 17.00 น. (ไม่พักกลางวันค่ะ)";
